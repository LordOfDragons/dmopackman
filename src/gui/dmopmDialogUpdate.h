...
#ifndef _DMOPMDIALOGUPDATE_H_
#define _DMOPMDIALOGUPDATE_H_
 ...
 * @date 2011
 */
class dmopmDialogUpdate : public FXDialogBox{
	FXDECLARE( dmopmDialogUpdate )
...
private:
	...
	FXLabel *pLabServerVersion;
	FXLabel *pLabPackageVersion;
	FXLabel *pLabStatus;
...
public:
	...
	dmopmDialogUpdate( FXWindow *owner, dmopmWindowMain *windowMain );
	/** Cleans up the dialog. */
	virtual ~dmopmDialogUpdate();
	/*@}*/
